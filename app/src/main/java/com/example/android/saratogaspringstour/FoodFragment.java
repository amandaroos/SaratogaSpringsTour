...
public class FoodFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        locations.add(new Location(getString(R.string.food1_name), getString(R.string.food1_address)));
        locations.add(new Location(getString(R.string.food2_name), getString(R.string.food2_address)));
